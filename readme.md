...
**Neuraxon Live -> Nxon GoL Server + Client V 1.060 v1080 (sept 2026) Including NxonKaleido Brain viz :** ([https://github.com/DavidVivancos/Neuraxon/tree/main/GameOfLife/NxonLive](https://github.com/DavidVivancos/Neuraxon/tree/main/GameOfLife/NxonLive))
